...
export const forecastCopy = {
  en: {
    ...
    orientation: "Panel orientation", tilt: "Roof tilt (°)", efficiency: "Efficiency (%)", maxOutput: "Maximum AC output (kW) · 0 = automatic", systemType: "System type", cancel: "Cancel", save: "Save & forecast", wait: "Please wait…",
  ...
  ur: {
    ...
    orientation: "پینل کی سمت", tilt: "چھت کا زاویہ (°)", efficiency: "کارکردگی (%)", maxOutput: "زیادہ سے زیادہ AC آؤٹ پٹ (kW) · خودکار کے لیے 0", systemType: "سسٹم کی قسم", cancel: "منسوخ", save: "محفوظ کریں اور پیشگوئی دیکھیں", wait: "انتظار کریں…",
